<?php get_header(); ?>
         ...
         <?php
                ...
                <li class="news-list">
                  ...
                  <p class="news-category">
                     <?php
                     $days = 3;
                     $today = date_i18n('U'); $entry_day = get_the_time('U'); $keika = date('U',($today - $entry_day)) / 86400;
                     if ( $days > $keika ):
                     $limit = 3;
                     $num = $wp_query->current_post; if ( $limit > $num ):
                     echo 'New';
                     endif;
                     endif;
                     ?> 
    ...
    <div class="concept">
      ...
      <div class="concept-content wrapper">
        ...
        <div class="slide active">　　<img src="img/top1.jpg" /></div>
        <div class="slide">　　<img src="img/top2.jpg" /></div>
        <div class="slide">　　<img src="img/top3.jpg" /></div>
        <div class="slide">　　<img src="img/top4.jpg" /></div>
    ...
    <div class="menu wrapper">
      <div class="menu-container">
        <h2 class="menu-title">期間限定MENU</h2>
    ...
    <div class="contact">
      ...
      <div class="contact-content wrapper">
        ...
        <div class="location-map">
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10592.332538869372!2d139.6886162896899!3d35.667261915557475!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x60188ca3f81b2913%3A0x6cf7f15501c79503!2z44Kt44Oj44OD44OI44K544OI44Oq44O844OI!5e0!3m2!1sja!2sjp!4v1599133963349!5m2!1sja!2sjp"
            width="800"
            height="400"
            frameborder="0"
            style="border: 0"
